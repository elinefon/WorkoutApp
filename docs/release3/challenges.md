...
The group focusing on the REST api found the implementation harder and more time consuming than expected. This was because none of the group members had done something similar before, and had to use a lot of resources to understand what to implement and how to connect it to the rest of the project.
